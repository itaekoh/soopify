  ...
  return (
    <section id="products">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center bg-white px-10 py-16 dark:bg-slate-950 md:px-16 md:py-24">
          ...
          <p className="mt-3 text-base font-semibold text-slate-500 dark:text-slate-400">나무병원 홈페이지 자동 제작 에이전트</p>
      ...
      {/* Soopdoc */}
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="flex flex-col justify-center bg-slate-50 px-10 py-16 dark:bg-slate-900 md:px-16 md:py-24 md:order-1">
          <span className="text-xs font-semibold uppercase tracking-widest text-slate-400">Coming Soon</span>
          <h2 className="mt-3 text-4xl font-semibold tracking-tight md:text-5xl">Soopdoc</h2>
          <p className="mt-3 text-base font-semibold text-slate-500 dark:text-slate-400">수목 조사 → 보고서 자동 작성 에이전트</p>
          <p className="mt-6 text-lg leading-relaxed text-slate-700 dark:text-slate-200">
